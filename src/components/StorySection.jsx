  ...
  return (
    <section className="py-16 px-4">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-16 text-gray-800 pixel-font">
          ★ 他们的故事 ★
        </h2>

        <div className="space-y-16">
          {storyItems.map((item, idx) => (
            <div key={idx} className={`flex flex-col ${idx % 2 === 1 ? 'md:flex-row-reverse' : 'md:flex-row'} gap-8 items-start`}>
              <div className="md:flex-1">
                <div className="bg-gradient-to-r from-blue-100 to-pink-100 rounded-lg p-6">
        ...
        <div className="mt-20 text-center bg-gradient-to-r from-blue-50 to-pink-50 rounded-lg p-10 border-2 border-gray-300">
